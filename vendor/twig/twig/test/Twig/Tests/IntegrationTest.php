...
class TwigTestTokenParser_Р’В§ extends Twig_TokenParser
{
    public function parse(Twig_Token $token)
    {
        $this->parser->getStream()->expect(Twig_Token::BLOCK_END_TYPE);

        return new Twig_Node_Print(new Twig_Node_Expression_Constant('Р’В§', -1), -1);
    }
...
class TwigTestExtension extends Twig_Extension
{
    ...
    {
        return array(
            new Twig_SimpleFilter('Р’В§', array($this, 'Р’В§Filter')),
    ...
    {
        return array(
            new Twig_SimpleFunction('Р’В§', array($this, 'Р’В§Function')),
    ...
    public function Р’В§Filter($value)
    {
        return "Р’В§{$value}Р’В§";
    }

    public function Р’В§Function($value)
    {
        return "Р’В§{$value}Р’В§";
    }
