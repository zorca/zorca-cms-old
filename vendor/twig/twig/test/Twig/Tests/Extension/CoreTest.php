...
class Twig_Tests_Extension_CoreTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testRandomFunctionOnNonUTF8String()
    {
        ...
        $text = twig_convert_encoding('Р“вЂћР“В©', 'ISO-8859-1', 'UTF-8');
        for ($i = 0; $i < 30; ++$i) {
            $rand = twig_random($twig, $text);
            $this->assertTrue(in_array(twig_convert_encoding($rand, 'UTF-8', 'ISO-8859-1'), array('Р“вЂћ', 'Р“В©'), true));
        }
    }
    ...
    public function testReverseFilterOnNonUTF8String()
    {
        ...
        $input = twig_convert_encoding('Р“вЂћР“В©', 'ISO-8859-1', 'UTF-8');
        $output = twig_convert_encoding(twig_reverse_filter($twig, $input), 'UTF-8', 'ISO-8859-1');

        $this->assertEquals($output, 'Р“В©Р“вЂћ');
    }
