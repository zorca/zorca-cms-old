...
class UrlGeneratorTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $routes = $this->getRoutes('$pР“В©Р“Сџ^a|', new Route('/bar'));

        $this->assertSame('/app.php/bar', $this->getGenerator($routes)->generate('$pР“В©Р“Сџ^a|'));
    }
    ...
    public function provideRelativePaths()
    {
        return array(
            ...
            array(
                '/special-chars/sp%20ce/1РІвЂљВ¬/mР“В¤h/e=mcР’Р†',
                '/special-chars/sp%20ce/1РІвЂљВ¬/<Р’Вµ>/e=mcР’Р†',
                '../<Р’Вµ>/e=mcР’Р†',
            ),
            array(
                'not-rooted',
